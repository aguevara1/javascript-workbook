...
/* Given 1000 digits of PI as strings, return an array of the digits as numbers. map() creates new array,
 parseInt() converts string numbers into number integers
*/
const nums = strNums.map((nums) => {
  return parseInt(nums);
});
console.log(nums);


/* Find the sum of the even values. reduce() checks for even numbers.If even number it adds
number to accumulator(total) variable. Initial value for total is set at 0.
*/
const sumEvens = nums.reduce((total, item) => {
  return item % 2 === 0 ? total + item : total + 0;
}, 0);
...
findIndex() returns the index when condition is true.
*/
...
/*using a higher order function, create an array of the unique 'weather_state_name' values of
